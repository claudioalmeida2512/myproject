            ...
            <div className='container col-12'>
                ...
                <div className="row">
                    <div className="form-group col-md-1"  >
                        ...
                        <NumberFormat format="###" mask="_" className="form-control" type="text" id="idcargo" name="idcargo" value={this.state.idcargo} onChange={this.handleChange} />
                    </div>
                    <div className="form-group col-md-5"  >
                        <label htmlFor="cargo_desc">Descrição</label>
                        <input className="form-control" type="text" id="cargo_desc" name="cargo_desc" value={this.state.cargo_desc} onChange={this.handleChange} />
                    </div>
                </div>
